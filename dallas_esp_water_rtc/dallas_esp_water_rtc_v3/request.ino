...
void coletaDados(){
  ...
  noSensor.concat(F("/statusAlerta&true"));
  noSensor.concat(F("/temperatuera&")); noSensor.concat(mediaTemperatura);
  noSensor.concat(F("/time&")); noSensor.concat(getDateTime());
  ////Tratamento de mensagem
  noSensor.concat(F("/tipoAlerta1&"));noSensor.concat(F("2"));
  noSensor.concat(F("/mensagem1&"));noSensor.concat(F("Coração acelerado"));
  
  noSensor.concat(F("/tipoAlerta2&"));noSensor.concat(F("1"));
  noSensor.concat(F("/mensagem2&"));noSensor.concat(F("Urinado"));
  
  noSensor.concat(F("/tipoAlerta3&"));noSensor.concat(F("-1"));
